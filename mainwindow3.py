import os, sys, re, pathlib, PyQt5.uic
from datetime import datetime
from os.path import expanduser
from PyQt5 import QtCore, QtGui, QtWidgets, uic
from PyQt5.QtWidgets import QMessageBox, QFileDialog, QApplication, QLabel, QHBoxLayout
from PyQt5.QtWidgets import QFileSystemModel, QTreeView, QWidget, QVBoxLayout
from threading import Timer
from PyQt5.QtGui import QIcon, QPixmap
from snowcatmans_media_filter import My_FFMF as M_F # movie filter
...
class MainWindow(UiBase):
    def __init__(self, parent=None):
        ...
        def my_filter_results(): # temperary fix later
            if None is None:
                pass
                # ??? I would like to know how to get a 
            #blank line or "--->" instead == None when next line printing
        print(M_F(self.path))
        # print(str(MFFF(self.path)))
